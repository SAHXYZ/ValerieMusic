...
# ===== Extra / Tools commands (public — usable by everyone) =====

HELP_E1 = """
<u><b>ɪᴍᴀɢᴇ ɢᴇɴᴇʀᴀᴛɪᴏɴ :</b></u>

/imagine [ᴘʀᴏᴍᴘᴛ] : ɢᴇɴᴇʀᴀᴛᴇs ᴀɴ ᴀɪ ɪᴍᴀɢᴇ ғʀᴏᴍ ʏᴏᴜʀ ᴘʀᴏᴍᴘᴛ.

<b>sɪᴢᴇs :</b> -hd  -wide  -square  -tall  -portrait  -landscape
<b>ғʟᴀɢs :</b> -seed N   -nologo

ᴇxᴀᴍᴘʟᴇ : <code>/imagine a neon city at night -hd</code>
/imaginehelp : sʜᴏᴡ ᴅᴇᴛᴀɪʟᴇᴅ ᴜsᴀɢᴇ.
"""

HELP_E2 = """
<u><b>ᴍᴍғ — ᴛᴇxᴛ ᴏɴ sᴛɪᴄᴋᴇʀ :</b></u>

/mmf "[ᴛᴇxᴛ]" [ᴘᴏsɪᴛɪᴏɴ] [sɪᴢᴇ] [ғᴏɴᴛ] [ᴄᴏʟᴏᴜʀs] : ᴡʀɪᴛᴇs ᴛᴇxᴛ ᴏɴ ᴀɴʏ ʀᴇᴘʟɪᴇᴅ ᴍᴇᴅɪᴀ ᴀɴᴅ ᴍᴀᴋᴇs ᴀ sᴛɪᴄᴋᴇʀ.

<b>ᴄᴏʟᴏᴜʀs :</b> ᴀɴʏ ᴄss ɴᴀᴍᴇ (red, crimson, gold…), ʜᴇx (#FF6B6B), rgb()/hsl(), ᴏʀ ᴇᴍᴏᴊɪ 🔴🟠🟡. ᴛᴡᴏ+ = ɢʀᴀᴅɪᴇɴᴛ.
<b>sɪᴢᴇ :</b> -size 90  ᴏʀ  tiny/small/big/huge/giant/max
<b>ғᴏɴᴛ :</b> bold, italic, mono, serif, caladea… ᴏʀ ᴀɴʏ ɪɴsᴛᴀʟʟᴇᴅ ғᴏɴᴛ.

ᴇxᴀᴍᴘʟᴇ : <code>/mmf "FIRE" bottom huge bold 🔴 🟠 🟡</code>
/mmfhelp : sʜᴏᴡ ғᴏɴᴛs &amp; ᴜsᴀɢᴇ.
"""

HELP_E3 = """
<u><b>sᴛɪᴄᴋᴇʀ ᴛᴏᴏʟs :</b></u>

/sticker : ᴄᴏɴᴠᴇʀᴛ ᴀ ʀᴇᴘʟɪᴇᴅ ɪᴍᴀɢᴇ ɪɴᴛᴏ ᴀ sᴛɪᴄᴋᴇʀ.
/unsticker : ᴄᴏɴᴠᴇʀᴛ ᴀ ʀᴇᴘʟɪᴇᴅ sᴛɪᴄᴋᴇʀ ʙᴀᴄᴋ ᴛᴏ ᴀɴ ɪᴍᴀɢᴇ.
/stickid : sʜᴏᴡ ɪɴғᴏ (ɪᴅ, sᴇᴛ, ᴇᴍᴏᴊɪ) ᴏғ ᴀ ʀᴇᴘʟɪᴇᴅ sᴛɪᴄᴋᴇʀ.
"""

HELP_E4 = """
<u><b>ᴋᴀɴɢ — sᴛɪᴄᴋᴇʀ ᴘᴀᴄᴋs :</b></u>

/kang [ᴇᴍᴏᴊɪ] : ᴀᴅᴅ ᴀ ʀᴇᴘʟɪᴇᴅ sᴛɪᴄᴋᴇʀ / ɪᴍᴀɢᴇ / ᴠɪᴅᴇᴏ ᴛᴏ ʏᴏᴜʀ ᴏᴡɴ ᴘᴀᴄᴋ.
/mypacks : ʟɪsᴛ ᴀʟʟ ʏᴏᴜʀ ᴘᴀᴄᴋs.

sᴜᴘᴘᴏʀᴛs sᴛᴀᴛɪᴄ, ᴠɪᴅᴇᴏ &amp; ᴀɴɪᴍᴀᴛᴇᴅ sᴛɪᴄᴋᴇʀs. ᴀᴜᴛᴏ-ᴄʀᴇᴀᴛᴇs ᴀ ɴᴇᴡ ᴘᴀᴄᴋ ᴡʜᴇɴ ᴏɴᴇ ɪs ғᴜʟʟ.

<i>ᴛɪᴘ : sᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ ɪɴ ᴅᴍ ᴏɴᴄᴇ ʙᴇғᴏʀᴇ ʏᴏᴜʀ ғɪʀsᴛ ᴋᴀɴɢ.</i>
"""

HELP_E5 = """
<u><b>ᴄʜᴀᴛ ᴛᴏᴏʟs :</b></u>

/purge : ʀᴇᴘʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ — ᴅᴇʟᴇᴛᴇs ᴇᴠᴇʀʏᴛʜɪɴɢ ғʀᴏᴍ ᴛʜᴇʀᴇ ᴛᴏ ʏᴏᴜʀ ᴄᴏᴍᴍᴀɴᴅ.
/del : ᴅᴇʟᴇᴛᴇ ᴛʜᴇ ʀᴇᴘʟɪᴇᴅ ᴍᴇssᴀɢᴇ.

<i>(ᴛʜᴇ ʙᴏᴛ ᴍᴜsᴛ ʙᴇ ᴀᴅᴍɪɴ ᴡɪᴛʜ ᴅᴇʟᴇᴛᴇ ᴘᴇʀᴍɪssɪᴏɴ.)</i>
"""

HELP_E6 = """
<u><b>ᴀ̳ғ̳ᴋ̳ :</b></u>

/afk [ʀᴇᴀsᴏɴ] : ᴍᴀʀᴋ ʏᴏᴜʀsᴇʟғ ᴀᴡᴀʏ. ᴡʜᴇɴ sᴏᴍᴇᴏɴᴇ ᴍᴇɴᴛɪᴏɴs ᴏʀ ʀᴇᴘʟɪᴇs ᴛᴏ ʏᴏᴜ, ᴛʜᴇ ʙᴏᴛ ᴀɴɴᴏᴜɴᴄᴇs ɪᴛ.
/unafk : ᴄᴏᴍᴇ ʙᴀᴄᴋ ᴍᴀɴᴜᴀʟʟʏ (ᴀɴʏ ᴍᴇssᴀɢᴇ ʏᴏᴜ sᴇɴᴅ ᴀʟsᴏ ᴄʟᴇᴀʀs ɪᴛ).
"""
