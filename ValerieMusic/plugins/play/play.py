...
import config
from ValerieMusic import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from ValerieMusic.core.call import Valerie
from ValerieMusic.utils import seconds_to_min, time_to_seconds
from ValerieMusic.utils.channelplay import get_channeplayCB
from ValerieMusic.utils.decorators.language import languageCB
from ValerieMusic.utils.decorators.play import PlayWrapper
from ValerieMusic.utils.formatters import formats
from ValerieMusic.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
from ValerieMusic.utils.stream.stream import stream
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        slider = True
        query = (message.text or message.caption or "").split(None, 1)[1]
        if "-v" in query:
...
@app.on_callback_query(filters.regex("ValeriePlaylists") & ~BANNED_USERS)
@languageCB
