...
from ValerieMusic.core.call import Valerie, autoend, counter
from ValerieMusic.utils.database import get_client, set_loop, is_active_chat, is_autoend, is_autoleave
import logging
    ...
    while True:
        ...
        try:
            ...
            for chat_id in chatss:
                try:
                    users = len(await Valerie.call_listeners(chat_id))
